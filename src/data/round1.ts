  ...
  matches: [
    {
      ...
      summary:
        "What a race! {johanna} dominated from start to finish, showing why she's called the Master of Momentum with her flowing racing lines that kept her ahead of the pack. The battle for second was intense, with {per-kristian} using his chaos mastery perfectly to claim the silver position with a perfectly timed red shell on the final lap! {ole-kristian} showed his strategic prowess by securing third place with mathematical precision, while {hedda}, despite being the pre-race favorite, had to settle for fourth after an unfortunate banana peel incident on Rainbow Road. Both {johanna} and {per-kristian} advance to the quarterfinals in what was an absolutely electric opening to the tournament!",
      players: [
